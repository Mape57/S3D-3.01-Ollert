 ...
 */
public abstract class TacheAbstraite<T extends Parent> extends Enfant<T> implements Parent, Serializable {
	 ...
	 */
	public TacheAbstraite(String titre) {
	 ...
	 * @throws NullPointerException si le titre est null
	 */
	public TacheAbstraite(String titre, LocalDate dateDebut, LocalDate dateFin) {
		if (titre == null) throw new NullPointerException("Le titre ne peut pas être null");
		this.titre = titre;
		this.description = "";
		this.dates = new LocalDate[2];
