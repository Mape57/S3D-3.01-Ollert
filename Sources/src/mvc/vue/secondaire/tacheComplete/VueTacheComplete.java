package mvc.vue.secondaire.tacheComplete;
...
import mvc.vue.secondaire.tacheComplete.contenu.*;
import mvc.vue.structure.Observateur;
import mvc.vue.structure.VueTache;

import java.util.List;

public class VueTacheComplete extends GridPane implements VueTache {

	/**
	 * Constructeur de la classe VueTacheInterface
	 */
	public VueTacheComplete(ModeleOllert modeleOllert) {

		VueTitreInterface vueTitreInterface = new VueTitreInterface();
		Label l5 = new Label("Fait partie de la liste \"" + modeleOllert.getTacheComplete().trouverListeTaches().getTitre() + "\"");
